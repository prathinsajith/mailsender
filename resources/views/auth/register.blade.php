    ...
    <form class="form text-center" id="kt_login_signup_form" method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group">
            <input
                ...
                type="text" placeholder="{{ __('Name') }}" name="name" id="username" value="{{ old('name') }}" required
        ...
        <div class="form-group">
            <input
                ...
                type="text" placeholder="{{ __('E-Mail Address') }}" name="email" id="email" value="{{ old('email') }}"
        ...
        <div class="form-group">
            <input
                ...
                id="password" type="password" placeholder="{{ __('Password') }}" name="password" required
